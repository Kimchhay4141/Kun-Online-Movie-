...
<div class="admin-page">
    <div class="container">
        ...
        <form action="{{ route('admin.movies.update', $movie) }}" method="POST" class="admin-form">
            @csrf
            @method('PUT')
            ...
            <div class="form-grid">
                ...
                <div class="form-group full-width">
                    ...
                    <input type="url" id="thumbnail" name="thumbnail" value="{{ old('thumbnail', $movie->thumbnail) }}">
                </div>

                <div class="form-group full-width">
                    <label for="banner">Banner URL</label>
                    <input type="url" id="banner" name="banner" value="{{ old('banner', $movie->banner) }}">
                </div>
